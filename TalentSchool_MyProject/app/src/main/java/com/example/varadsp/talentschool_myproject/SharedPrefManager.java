...
public class SharedPrefManager {
    ...
    private static final String KEY_CERTIFICATE= "keycertificate";
    ...
    public void userLogin(User user) {
        ...
        editor.putString(KEY_CERTIFICATE, user.getCertificate());
    ...
    public User getUser() {
        ...
        return new User(
                ...
                sharedPreferences.getString(KEY_CERTIFICATE, null),
